...
<div class="cont user user_0 clearfix">
	<div class="user_menu"> 
        <dl>
            ...
            <dd><a href="#">商品评价</a></dd>
            <dd class="active"><a href="<?php echo U('user/editpwd');?>">修改密码</a></dd>
        </dl>
    </div>

<!--  个人信息内容  -->
        <div class="user_right fr">
            <h3 class="user_title">个人信息</h3>

			<div class="user_rc clearfix">
				<p>亲爱的&nbsp;<span><?php echo ($row['username']); ?></span>，填写真实的资料，有助于好友找到你哦。</p>
                <form action="<?php echo U('user/userinfo');?>" method='post' id='form_info' enctype="multipart/form-data">
                <table width="500" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <th class="zg_person_th">当前头像：</th>
                        <td>
                    	   <img src="<?php echo ($row['photo']); ?>" width="120" height="120" alt="我的头像">
                            <label class="userInfo_file"><input type="file" name='photo'>上传头像</label>
                        </td>
                    </tr>
                    <tr>
                        <th>邮箱帐号：</th>
                        <td class="user_mail">
                    	   <span><?php echo ($row['email']); ?></span>
                            <span>未验证 <a href="#">去验证</a></span>
                            <span>已验证 <a href="#">修改邮箱</a></span>
                        </td>
                    </tr>
                    <tr>
                        <th>昵称：</th>
                        <input type='hidden' name='id' value="<?php echo ($row['id']); ?>">
                        <td><input type="text" name='nikname' value="<?php echo ($row['nikname']); ?>" class="zg_person_text focusBorder"></td>
                    </tr>
                    <tr>
                        <th>手机：</th>
                        <td><input type="text" name='tel' value="<?php echo ($row['tel']); ?>" class="zg_person_text focusBorder"></td>
                    </tr>
                    <tr>
                        <th>QQ：</th>
                        <td><input type="text" name='qq' value="<?php echo ($row['qq']); ?>" class="zg_person_text focusBorder"></td>
                    </tr>
                    <tr>
                        <th>性别：</th>
                        <td>
                    	   <label class="userInfo_radio"><i <?php if($row['sex'] == 1): ?>class='checked'<?php endif; ?> >&nbsp;</i><input type="radio" name="sex" value="1">男</label>
                    	   <label class="userInfo_radio"><i <?php if($row['sex'] == 2): ?>class="checked"<?php endif; ?> >&nbsp;</i><input type="radio" name="sex" value="2">女</label>
                        </td>
                    </tr>
                </table>
                <input type="submit" value="提交"  class="zg_person_submit">
                </form>                
            </div>
		</div>
